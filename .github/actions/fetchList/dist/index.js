...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(6167)("follow-redirects");
    }
    catch (error) { /* */ }
...
module.exports = __nccwpck_require__(2624)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(6628);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	...
	module.exports = __nccwpck_require__(5305);
}
